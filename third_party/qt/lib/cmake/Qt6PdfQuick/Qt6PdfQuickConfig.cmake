...
if (NOT QT_NO_CREATE_TARGETS AND Qt6PdfQuick_FOUND)
    ...
    if(NOT Qt6PdfQuick_DEFINITIONS)
        ...
        set(updated_defs "")
        foreach(def IN LISTS  Qt6PdfQuick_DEFINITIONS)
        ...
        endforeach()
        set(Qt6PdfQuick_DEFINITIONS "${updated_defs}")
        unset(updated_defs)
    endif()
...
if (TARGET Qt6::PdfQuick)
    ...
    if(NOT QT_NO_CREATE_VERSIONLESS_TARGETS)
        if(CMAKE_VERSION VERSION_LESS 3.18 OR QT_USE_OLD_VERSION_LESS_TARGETS)
            ...
            include("${CMAKE_CURRENT_LIST_DIR}/Qt6PdfQuickVersionlessAliasTargets.cmake")
        endif()
    endif()
else()
