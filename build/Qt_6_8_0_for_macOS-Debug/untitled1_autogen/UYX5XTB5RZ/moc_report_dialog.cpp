...
static constexpr auto qt_meta_stringdata_ZN12ReportDialogE = QtMocHelpers::stringData(
    "ReportDialog",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ReportDialogE[] = {
...
Q_CONSTINIT const QMetaObject ReportDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ReportDialogE.offsetsAndSizes,
    qt_meta_data_ZN12ReportDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ReportDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *ReportDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ReportDialogE.stringdata0))
